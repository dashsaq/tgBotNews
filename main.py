...
bot = telebot.TeleBot("6028864518:AAHqEh-g6eHzHD-IoaQh71_p4h7OWiykx-M", parse_mode=None)
newsapi = NewsApiClient(api_key="9d4b3ab9397e4ceca14c4cf442d097be")
...
def send_welcome(message):
    ...
    if not user:
        ...
        bot.reply_to(message, "Рады Вас видеть!)",reply_markup=markup)
